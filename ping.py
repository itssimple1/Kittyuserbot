...
its_simple1 = borg.uid
KITTY_IMG = Config.ALIVE_PIC
...
async def _(event):
    ...
    ms = (end - start).microseconds / 1000
    if KITTY_IMG:
        kitty_caption = f"__**〘 ♕ ᑭσɳց! ♕ 〙__**\n\n   ⚘ {ms}\n   ⚘ __**𝙼𝚢**__ __**𝙼𝚊𝚜𝚝𝚎𝚛**__⟿[{DEFAULTUSER}](tg://user?id={its_simple1})"
        await event.client.send_file(
            event.chat_id, KITTY_IMG, caption=Kitty_caption
        )
        await event.delete()

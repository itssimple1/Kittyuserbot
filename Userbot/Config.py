...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "KittyUserBot")
       ...
       # PLUGIN_CHANNEL = int(os.environ.get("PLUGIN_CHANNEL", None))
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/itssimple1/kittyuserbot"
        )
        ...
        EXTRA_KITTYBOT = os.environ.get("EXTRA_KITTYBOT", -1001221881562)
        PM_DATA = os.environ.get("PM_DATA", "ENABLE")
        KITTYBOT_LOGGER = int(os.environ.get("KITTYBOT_LOGGER", None))
